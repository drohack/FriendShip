...
public class Command_Array : MonoBehaviour {
    ...
    private const string button8Text = "Interdimensional Time Warp";
    private const string button9Text = "Flux Capacitors";
    private const string button10Text = "Waifus";
    private const string button11Text = "Husbandos";
